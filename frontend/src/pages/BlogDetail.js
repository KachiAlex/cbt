          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-6">
              <Link to="/home" className="flex items-center">
                <img src="/logo-cbtpromax.png" alt="CBTProMax logo" className="w-8 h-8 rounded-lg mr-2" /><span className="text-2xl font-bold text-blue-600">CBTProMax</span>
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-4">
                <img src="/logo-cbtpromax.png" alt="CBTProMax logo" className="w-8 h-8 rounded-lg mr-2" /><span className="text-2xl font-bold text-blue-400">CBTProMax</span>
              </div>
