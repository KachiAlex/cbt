...
const FreeTrial = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiRequest('/api/schedule-demo', {
        method: 'POST',
      ...
      alert('There was an error submitting your request. Please try again or email sales@cbtpromax.com');
    } finally {
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 text-center">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-gray-500 text-sm">
                Need immediate assistance? Contact us at <a href="tel:+2347039612627" className="text-blue-600 hover:underline">+2347039612627</a> or <a href="mailto:sales@cbtpromax.com" className="text-blue-600 hover:underline">sales@cbtpromax.com</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link to="/home" className="flex items-center space-x-2">
                <img src="/logo-cbtpromax.png" alt="CBTProMax logo" className="w-8 h-8 rounded-lg" />
      ...
      <section className="py-16 bg-gradient-to-r from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a
              href="mailto:sales@cbtpromax.com"
              className="flex items-center space-x-2 bg-white text-gray-700 px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
            >
              <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
